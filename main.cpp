...
constexpr std::string_view PRODUCT_NAMES[static_cast<int>(Product::Count)] = {
    ...
    [static_cast<int>(Product::oranges)]         = "oranges",
    [static_cast<int>(Product::plantains)]       = "plantains",
    [static_cast<int>(Product::apples)]          = "apples",
    [static_cast<int>(Product::lemonade)]        = "lemonade",
    [static_cast<int>(Product::chickenmeat)]     = "chickenmeat",
    [static_cast<int>(Product::lambmeat)]        = "lambmeat",
    [static_cast<int>(Product::beefmeat)]        = "beefmeat",
